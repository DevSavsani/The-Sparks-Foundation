...
<body data-spy="scroll" data-target="#navbarResponsive">
  ...
  <!--Navigation-->
	<nav class="navbar navbar-expand-md navbar-dark bg-dark fixed-top">
		<a class="navbar-brand"href="index.php">SIB</a>
		...
		<div class="carousel-inner"role="listbox">
			<div class="carousel-item active"style="background-image: url('img/main1.jpg');">
				<div class="carousel-caption text-center">
					<h5 style="color:white;">Welcome to Singapore International Bank</h5>
				  <br>
					<br>
					</div>
		</div>
			<div class="carousel-item"style="background-image: url('img/main2.jpg');"></div>
				<div class="carousel-item"style="background-image: url('img/main3.png');"></div>
...
<section class="services" class="offset">
                <h2 id="services1"></h2>
                        <div class="s-heading">
                        <h1 >OU<font color="#33cccc">R SERVI</font>CES</h1 >
                ...
                <div class="s-box-container">
                        ...
                        <div class="s-box">
                         ...
                         <div class="s-box">
                                <div class="bar"></div>
                                <img src ="img/transfer.jpg" alt="2">
                                <h1>Transfer Money</h1>
                                <a href="moneytransfer.php" class="s-btn" >View</a>
                        </div>
                                <div class="s-box">
                                <div class="bar"></div>
                                <img src ="img/transaction.jpg" alt="3">
                                <h1>Transactions</h1>
	...
	<footer>
		<div class="row justify-content-center">
			<div class="col-md-5 text-center">
				<p style="text-align:center">SIB</p>
			...
			<hr class="socket">
			&copy; Singapore internationl bank.
		</div>
	</footer>
</div>
<!--- Script Source Files -->
